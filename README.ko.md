...
나머지는 아직 안 만든 것이고 [ROADMAP.md](ROADMAP.md) 에서 추적합니다: 한도 리셋 카운트다운,
번레이트 예측, 페이지가 있는 종 도감, 포획 로그, 플로팅 펫의 호버 정보·우클릭 메뉴·말풍선 알림,
펫 크기·경고 임계값 슬라이더, Keychain 옵트아웃, 인앱 업데이트 확인, 세이브 내보내기·가져오기.
