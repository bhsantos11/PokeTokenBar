...
@inline(__always) func asOffscreenWindow(_ w: Widget) -> UnsafeMutablePointer<GtkOffscreenWindow> {
    UnsafeMutableRawPointer(w).assumingMemoryBound(to: GtkOffscreenWindow.self)
}
